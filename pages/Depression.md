...
- ## Etiology  
  background-color:: blue
	...
	- ### Risk Factors
		...
		- Substance abuse.
		- Social isolation.
	- Name of Depressive Disorder #shaheen
		- Parkinson's Disease
		- Alzheimer's Disease
		- Epilepsy
		- Malignancy
...
- ## Clinical Features  
  background-color:: blue
	...
	- #### **2. Somatic (Physical) Symptoms**
		...
		- **Appetite/weight changes** (significant loss or gain)
		- **Psychomotor agitation or retardation** (slowed movements/speech)
		- **Unexplained aches/pains** (headaches, digestive issues)
		- **Reduced libido**
	- ### Stages or Classification
		- Main Classification
			- **Mild:** Few symptoms, manageable but impacting daily life.
			- **Moderate:** More symptoms, noticeable functional impairment.
			- **Severe:**
				- Many symptoms, major disability.
				- **With psychotic features** (delusions/hallucinations, often mood-congruent).
		- **Other subtypes:**
			- Melancholic (severe anhedonia, worse in morning)
			- Atypical (mood reactivity, weight gain, hypersomnia)
			- Seasonal (episodes in winter months)
- ## Diagnosis  
  background-color:: blue
	- ### Diagnostic Criteria
